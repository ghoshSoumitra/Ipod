    ...
    render() {
        ...
        return (
            <div style={{backgroundImage:`url(${wallpaperItems[wallpaper]})`}} className="display">
                ...
                {currentMenu === 2 && <div className="blank-div"><h1 className="empty-text"> 
                <img src="https://www.lifewire.com/thmb/gAly30YDL-YdYVm9mrsJQTkTIMc=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/speed-racing-pro-2-082aeab9eda345599d530bd2c90b752b.png" alt="Image" className="empty-image" /></h1></div>}
